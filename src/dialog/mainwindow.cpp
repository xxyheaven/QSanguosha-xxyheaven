...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::MainWindow), server(NULL), m_client(NULL)
{
    ui->setupUi(this);
...
void MainWindow::startConnection()
{
    ...
    connect(m_client, SIGNAL(version_checked(QString, QString)), SLOT(checkVersion(QString, QString)));
    connect(m_client, SIGNAL(error_message(QString)), SLOT(networkError(QString)));
}
