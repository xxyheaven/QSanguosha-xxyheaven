...
public:
    ...
    QPixmap getPixmap(const QString &key, const QString &arg = QString(), const QString &arg2 = QString(), bool cache = false) const;
...
public:
    ...
    struct PlayerCardContainerLayout
    {
        ...
        QRect m_handPileArea;

        // equips
        QRect m_equipAreas[S_EQUIP_AREA_LENGTH];
        QRect m_horseAreas[S_HORSE_AREA_LENGTH];
        ...
        QSanShadowTextFont m_handPileFont;
    ...
    static const char *S_SKIN_KEY_MAGATAMAS_NUMBER;
    ...
    static const char *S_SKIN_KEY_HORSE_ICON;
    ...
    static const char *S_SKIN_KEY_GENERAL_CARD_ITEM_ARROWS;
