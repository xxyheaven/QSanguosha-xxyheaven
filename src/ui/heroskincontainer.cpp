    ...
    m_vScrollBar(NULL), m_oldScrollValue(0)
{
    ...
    PlayerCardContainer::_paintPixmap(nameBgItem, QRect(11, 6, 87, 21),
        G_ROOM_SKIN.getPixmap(QSanRoomSkin::S_SKIN_KEY_DASHBOARD_KINGDOM_COLOR_MASK, kingdom), this);
...
{
    if (Self->getGeneralName() == m_generalName)
