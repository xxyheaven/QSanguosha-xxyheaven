...
public:
    ...
    virtual void addCostcard(int card_id);
    virtual void addCostcard(const Card *card);
    virtual QList<int> getSubcards() const;
    virtual QList<int> getCostcards() const;
    virtual void clearSubcards();
    virtual bool usecontains(int card_id) const;
    virtual bool usecontains(const Card *card) const;
    virtual QString subcardString() const;
    virtual QString costcardString() const;
    virtual void addSubcards(const QList<const Card *> &cards);
    virtual void addSubcards(const QList<int> &subcards_list);
    virtual void addCostcards(const QList<const Card *> &cards);
    virtual void addCostcards(const QList<int> &subcards_list);
