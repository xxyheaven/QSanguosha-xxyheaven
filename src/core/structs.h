...
public:
    ...
    QVariant m_extraData; // additional data
    ...
    static const int S_REASON_NATURAL_MOVE = 0x2A;     //  a card with no-owner move into discardpile
    ...
    static const int S_REASON_SECRETLY_PUT = 0x6A;      //  swap cards or guhuo
