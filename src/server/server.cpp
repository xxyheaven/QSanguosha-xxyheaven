...
QWidget *ServerDialog::createAdvancedTab()
{
	...
	layout->addLayout(HLay(new QLabel(tr("Extra choice for loyalist")), loyalist_extra_choice_spinbox));
	layout->addLayout(HLay(new QLabel(tr("Extra choice for renegade")), renegade_extra_choice_spinbox));
