...
void RoomThread1v1::run()
{
    ...
    if (!Config.value("1v1/UsingExtension", false).toBool()) {
        ...
        if (rule == "Classical") {
            ...
            candidates << "nos_caocao" << "nos_simayi" << "nos_xiahoudun" << "nos_zhangliao"
                << "nos_xuchu" << "nos_guojia" << "zhenji" << "xiahouyuan"
                << "nos_caoren" << "dianwei" << "nos_guanyu" << "nos_zhangfei"
                << "zhugeliang" << "nos_zhaoyun" << "nos_machao" << "nos_huangyueying"
                << "huangzhong" << "jiangwei" << "menghuo" << "zhurong"
                << "sunquan" << "nos_ganning" << "nos_huanggai" << "nos_zhouyu"
                << "nos_luxun" << "sunshangxiang" << "sunjian" << "xiaoqiao"
                << "nos_lvbu" << "nos_diaochan" << "yanliangwenchou" << "hejin";
            if (rule == "2013") {
                candidates << "nos_liubei" << "weiyan" << "nos_lvmeng" << "nos_daqiao"
                    << "nos_zhoutai" << "nos_huatuo" << "nos_zhangjiao" << "pangde"
                    << "niujin" << "hansui";
            }
        }
        qShuffle(candidates);
