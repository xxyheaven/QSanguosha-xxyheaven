...
public:
    enum Status
    {
        ...
        AskForGeneralTaken = 0x01000D,
        AskForGeneralChosen = 0x01000E,
        AskForArrangement = 0x00000F,
        AskForChoice = 0x010010,
        //AskForTriggerOrder = 0x010011,
        AskForCardChosen = 0x010012,
        //AskForSuit = 0x010013,
        AskForMoveCards = 0x000014,
    ...
    void showDummyCard(const QVariant &show_str);
...
public slots:
	...
	void onPlayerChooseCards(const QList<int> &card_ids);
...
signals:
    ...
    void dummy_shown(const CardMoveReason &reason);
