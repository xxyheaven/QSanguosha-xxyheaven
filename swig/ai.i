...
public:
	...
	virtual QList<int> askForCardsChosen(ServerPlayer *who, const QString &flags, const QString &reason, int min_num, int max_num, Card::HandlingMethod method) = 0;
...
public:
    ...
    virtual QList<int> askForCardsChosen(ServerPlayer *who, const QString &flags, const QString &reason, int min_num, int max_num, Card::HandlingMethod method);
...
QList<int> LuaAI::askForCardsChosen(ServerPlayer *who, const QString &flags, const QString &reason, int min_num, int max_num, Card::HandlingMethod method)
{
    lua_State *L = room->getLuaState();
    ...
    if (error) {
        ...
        return TrustAI::askForCardsChosen(who, flags, reason, min_num, max_num, method);
    }
