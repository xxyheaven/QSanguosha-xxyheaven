CommonTranslationTable = {
	...
	["BasicCard"] = "基本牌",
	["TrickCard"] = "锦囊牌",
	["SingleTargetTrick"] = "单目标锦囊牌",
	["MultiTargetTrick"] = "多目标锦囊牌",
	["DelayedTrick"] = "延时类锦囊牌",
	["EquipCard"] = "装备牌",
	["ndtrick"] = "非延时类锦囊牌",
	["luck_card"] = "手气卡",
	...
	["#ChoosePlayerWithSkill"] = "%from 对 %to 发动了技能“%arg”",
	["#TriggerSkill"] = "%from 的武将技能“%arg”被触发",
	["#TriggerEquipSkill"] = "%from 的装备技能【%arg】被触发",
	["#SkillForce"] = "%from 的武将技能“%arg”生效",
	["#Pindian"] = "%from 向 %to 发起了拼点",
	["#PindianSuccess"] = "%from (对 %to) 拼点赢！",
	["#PindianFailure"] = "%from (对 %to) 拼点没赢",
	["#Damage"] = "%to 受到 %from 造成的 %arg 点伤害，体力值为 %arg2",
	["#DamageFire"] = "%to 受到 %from 造成的 %arg 点<font color=\"red\"><b>火属性</b></font>伤害，体力值为 %arg2",
	["#DamageThunder"] = "%to 受到 %from 造成的 %arg 点雷属性伤害，体力值为 %arg2",
	["#DamageNoSource"] = "%to 受到 %arg 点伤害，体力值为 %arg2",
	["#DamageFireNoSource"] = "%to 受到 %arg 点<font color=\"red\"><b>火属性</b></font>伤害，体力值为 %arg2",
	["#DamageThunderNoSource"] = "%to 受到 %arg 点雷属性伤害，体力值为 %arg2",
	["#Recover"] = "%from 回复 %arg 点体力，体力值为 %arg2",
	["#RecoverDying"] = "%from 回复 %arg 点体力，还需回复 %arg2 点体力",
	["#AskForPeaches"] = "%from 向 %to 求 %arg 张【<font color=\"yellow\"><b>桃</b></font>】",
	...
	["$ChangedJudge"] = "%from 发动“%arg”把 %to 的判定牌替换为 %card",
	["$MoveCard"] = "%to 获得了 %from 的 %card",
	["$PasteCard"] = "%from 对 %to 使用延时锦囊 %card",
	["$LightningMove"] = "%card 从 %from 移动到 %to",
	["$TurnOver"] = "%from 从牌堆顶翻开 %card",
	["$DiscardCard"] = "%from 弃置了 %card",
	["$DiscardCardWithSkill"] = "%from 发动“%arg”弃置了 %card",
	["$RecastCardWithSkill"] = "%from 发动“%arg”重铸了 %card",
	...
	["fire_nature"] = "火属性",
	["thunder_nature"] = "雷属性",
	["#Contingency"] = "%to 阵亡<br/>%to 的身份是 %arg",
	...
	["#TakeNCards"] = "%from 获得了 %arg 张牌",
	["$Install"] = "%from 装备了 %card",
	["$Uninstall"] = "%from 失去了装备牌 %card",
	["$PutEquip"] = "%from 将 %card 置于 %to 的装备区",
	["$JudgeResult"] = "%from 的判定结果为 %card",
	["$PindianResult"] = "%from 的拼点牌为 %card",
	["#ChooseSuit"] = "%from 选择了花色 %arg",
	["#TurnOver"] = "%from 将武将牌翻至 %arg",
	["face_up"] = "正面朝上",
	["face_down"] = "背面朝上",
	["#ChainStateChange"] = "%from 将武将牌 %arg",
	["chain"] = "横置",
	["reset"] = "重置",
	["#SkipPhase"] = "%from 跳过了 %arg 阶段",
	["#SkipAllPhase"] = "%from 当前回合结束",
	["#IronChainDamage"] = "%from 处于连环状态，将受到传导的属性伤害",
	["#LoseHp"] = "%from 失去 %arg 点体力，体力值为 %arg2",
	["#LoseMaxHp"] = "%from 减少 %arg 点体力上限，体力上限为 %arg2",
	["#GainMaxHp"] = "%from 增加 %arg 点体力上限，体力上限为 %arg2",
	...
	["#GainExtraPhase"] = "%from 进行一个额外的 %arg 阶段",
	...
	["drawpiletop"] = "置于牌堆顶",
	["drawpilebottom"] = "置于牌堆底",
	["obtain"] = "获得的牌",
	
	["@askfortriggerorder"] = "请选择要触发的技能",
}
