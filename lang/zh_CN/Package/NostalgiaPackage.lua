...
return {
	...
	["nosfanjian"] = "反间",
	[":nosfanjian"] = "出牌阶段限一次，你可以令一名其他角色选择一种花色，然后正面朝上获得你的一张手牌。若此牌花色与该角色所选花色不同，该角色受到1点伤害。",
	...
	["&nos_diaochan"] = "貂蝉",
	["noslijian"] = "离间",
	[":noslijian"] = "出牌阶段限一次，你可以弃置一张牌并选择两名男性角色：若如此做，视为其中一名角色对另一名角色使用一张【决斗】，此【决斗】不能被【无懈可击】响应。",
	...
	["noswuyan"] = "无言",
	[":noswuyan"] = "锁定技，你使用的普通锦囊牌对其他角色无效。其他角色使用的普通锦囊牌对你无效",
	["nosjujian"] = "举荐",
	...
	["@noschengxiang"] = "请选择任意张点数之和小于13的牌，其余的弃置",
	["noschengxiang#up"] = "置入弃牌堆",
	["noschengxiang#down"] = "获得的牌",
	["nosrenxin"] = "仁心",
	...
	["nosmieji"] = "灭计",
	[":nosmieji"] = "当你使用黑色锦囊牌选择目标后，若此牌的目标角色数为1，你可以令一名角色也成为此牌的目标。",
	...
	["nospower"] = "权",
	["nosbaijiang"] = "拜将",
	[":nosbaijiang"] = "觉醒技，准备阶段开始时，若你的装备区的装备牌大于或等于三张，你增加1点体力上限，回复1点体力，然后失去“权计”和“争功”并获得“野心”（每当你造成或受到伤害后，你可以将牌堆顶的一张牌置于武将牌上，称为“权”。出牌阶段限一次，你可以将至少一张手牌与等量的“权”交换）。",
	["$NosBaijiangAnimate"] = "image=image/animate/nosbaijiang.png",
	["nosyexin"] = "野心",
	[":nosyexin"] = "每当你造成或受到伤害后，你可以将牌堆顶的一张牌置于武将牌上，称为“权”。出牌阶段限一次，你可以将至少一张手牌与等量的“权”交换。",
	["noszili"] = "自立",
